<div>
	<h5>klik disini untuk menambahkan data</h5><br>
...
<div class="box">
	<div class="box-header">
		<h6 class="box-title">DATA USER</h6>
	</div>
	<!-- /.box-header -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title"> assalammualaikum</h4>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-outline">Tidak</button>
              </div>
          </form>
            </div>
          </div>
